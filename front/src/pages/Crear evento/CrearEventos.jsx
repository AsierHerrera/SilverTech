...
const CrearEventos = () => {
  ...
  return (
    <div>
    <p className="navegation-history" > <span>Inicio</span>  {">"} <span>Networking</span> {">"} <span></span>Crear Evento</p>

    <div className={styles.formContainer}>
      <h2 className={styles.formTitle}>Crear Nuevo Evento</h2>
      <div className={styles.sectionTitle}>Datos del Evento</div>
      <form onSubmit={handleSubmit}>
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Título del Evento</label>
          <input
            type="text"
            name="title"
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Categoría a la que pertenece el Evento</label>
          <input
            type="text"
            name="category"
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Descripción del Evento</label>
          <textarea
            name="description"
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Beneficiarios del Evento</label>
          <input
            type="text"
            name="beneficiaries"
        ...
        <div className={styles.dateGroup}>
          <div className={styles.dateField}>
            <label className={styles.formLabel}>Día de inicio del Evento</label>
            <input
              type="date"
              name="startDate"
          ...
          <div className={styles.dateField}>
            <label className={styles.formLabel}>Día de Evento</label>
            <input
              type="date"
              name="endDate"
        ...
        <button type="submit" className={styles.formSubmit}>Crear Evento</button>
      </form>
    </div>
